...
# Form implementation generated from reading ui file '/ssynthesia/ghostcity/git-pub/autosinta/ui/main_gui.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_av.setGeometry(QtCore.QRect(20, 50, 471, 101))
        ...
        self.input_avuser.setGeometry(QtCore.QRect(80, 30, 241, 25))
        self.input_avuser.setObjectName("input_avuser")
        self.input_avpass = QtWidgets.QLineEdit(self.frame_av)
        self.input_avpass.setGeometry(QtCore.QRect(80, 60, 241, 25))
        ...
        self.btn_login = QtWidgets.QPushButton(self.frame_av)
        self.btn_login.setGeometry(QtCore.QRect(400, 60, 61, 25))
        self.btn_login.setObjectName("btn_login")
        self.frame_sync = QtWidgets.QFrame(self.centralwidget)
        self.frame_sync.setEnabled(False)
        self.frame_sync.setGeometry(QtCore.QRect(20, 160, 471, 61))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.input_avuser.setPlaceholderText(_translate("MainWindow", "e.g., adminsinta@univ.ac.id"))
